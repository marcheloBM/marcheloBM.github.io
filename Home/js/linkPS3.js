...
function Artemis(){verificarSesionYAbrirEnlace("https://mega.nz/folder/KURhALwT#9-ZDPdzFzxYQsMrf8ElSpQ");}
function ArtemisWeb(){verificarSesionYAbrirEnlace("https://github.com/bucanero/ArtemisPS3/releases");}
function BTGA303CORO48X(){verificarSesionYAbrirEnlace("https://mega.nz/folder/6Vx21Y4R#_Ha-UPXAwINvYBWpNuS2LA");}
function Licencias(){verificarSesionYAbrirEnlace("https://mega.nz/folder/6QozRYqa#74ZPBcyToxXC1lTonhWkdQ");}
...
function FileManager(){verificarSesionYAbrirEnlace("https://mega.nz/folder/icgBWJSB#Cn05LfNpyITZ_QFEiPbk7Q");}
function FileManagerWeb(){verificarSesionYAbrirEnlace("https://github.com/Zarh/ManaGunZ/releases");}
function SimpleFileManager(){verificarSesionYAbrirEnlace("https://mega.nz/folder/TJgGnbRY#d9GKwMeC-S4pU3JPsgfmRA");}
function SimpleFileManagerWeb(){verificarSesionYAbrirEnlace("https://github.com/lmirel/fm_psx/releases");}
function HybrindFirmwareTools(){verificarSesionYAbrirEnlace("https://mega.nz/folder/eRh3nCbK#yOZXvFhpPXCXEzJt2H1JLA");}

function PS2APP(){verificarSesionYAbrirEnlace("https://mega.nz/folder/uVIkGDRL#3fYuq6rtixi2lq_Rpa2eWw");}
function exdata(){verificarSesionYAbrirEnlace("https://mega.nz/folder/XERBEC7a#4czulX8m2Cs75S4oUfYWiw");}
...
function VIDEOSTORE(){verificarSesionYAbrirEnlace("https://mega.nz/folder/6FoyAJQT#t84Eze-EIZOtji3VN8nSaw");}
...
function APP(){verificarSesionYAbrirEnlace("https://mega.nz/folder/nBR0UZgY#kdeTfvUVOf9FzoP6oN4c0Q");}
