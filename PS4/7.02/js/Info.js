...
function cargarApp2USB(){
	document.getElementById("msj").innerHTML = "Transferir juegos / aplicaciones a una unidad USB en exFAT";
}
function cargarDisableUpdate(){
	document.getElementById("msj").innerHTML = "Desactivar actualizaciones del sistema";
}
...
function titulopag(){
	document.getElementById("msj").innerHTML = "PS4 7.02 Host x MarcheBM";
}
